...
capture log close
/*******************************************************************************
PROJECT:	Read in 5-year ACS data
...
collapse (sum) pop* obs*, by(year multiyear statefip puma sex race age_lt)
compress
save ${out}\acs5yr_2008_2017_wide_alled.dta, replace
